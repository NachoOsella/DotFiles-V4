/**
 * The Pi backend interface. The in-process Pi AgentSession implementation
 * produces the normalized `SubagentSession` shape.
 */
...
/** Registry containing the Pi backend, keyed by name. */
